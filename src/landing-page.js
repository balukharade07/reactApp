   ...
   <div className="App" >
    ...
    <div className="row info_block">
        <div className="container">
          ...
          <img className="img-fluid" src={images1} alt="images1"></img>
              <p className="comment_title">Boomers, Millenials, Gen X - they're all Generation Wireless. Offer the essential amenity, on your terms.</p>
          </div>
          <div className="col-md-6 offset-md-1">
              <h3 className="title">IS YOUR WIFI WORKING FOR YOU?</h3>
              <p>Customers expect WiFi access and you provide it. But what does that access provide you?</p>
              <p>Can you <span className="highlight">promote your company</span>, advertise specials, announce something new? Can you pair access with a purchase, or place a limit on browsing time?</p>
              <p>With your online Logic Hotspot account you can customize your WiFi gateway and <span className="highlight">govern access</span> at any time.</p>
              <p>Plug in our palm-sized router, and you're good to go. No contract, no fine print, just plug and play. And we stand by our equipment with a <span className="highlight">lifetime guarantee</span>.</p>
          </div>
      </div>
      </div>
  </div>
      ...
      <div className="row">
          <div className="col-md-6 offset-md-3">
              <span  className="learmore_btn">
                      Click here to get in touch and learn more about how to maximize your WiFi.
              </span>
          </div>
      </div>
  </div>
